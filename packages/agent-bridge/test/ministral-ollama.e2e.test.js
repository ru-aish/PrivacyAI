...
const enabled = process.env.PRIVACYAI_OLLAMA_E2E === "1";
const model = process.env.PRIVACYAI_E2E_MODEL || "ministral-3:3b";
const baseURL = process.env.PRIVACYAI_E2E_BASE_URL || "http://127.0.0.1:11434";
...
test("Ministral 3 3B protects the prompt and Bash lifecycle end to end", { skip: !enabled }, async t => {
  ...
  const sessionId = "ministral-e2e-session";
