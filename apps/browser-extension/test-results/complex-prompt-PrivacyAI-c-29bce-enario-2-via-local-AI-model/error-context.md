...
- Name: complex-prompt.spec.js >> PrivacyAI complex prompt sanitization >> sanitizes complex scenario 2 via local AI model
- Location: tests/complex-prompt.spec.js:109:5
...
Expected: "I work at Harborview Systems. SSN 482-91-3307. Email priya.k@corp.net for follow-up."
Received: "I'm Eleanor Vance, call me at 415-555-9821. Groq API key: gsk_live_secret_xyz99"
```
